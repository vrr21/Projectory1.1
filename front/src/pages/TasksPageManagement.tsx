...
import SidebarManager from '../components/SidebarManager'; // ← исправленный импорт
import '../styles/pages/ProjectManagementPage.css';  // Убедитесь, что файл стилей существует!
